...
In his country, it's usual to tip 15% if the bill value is between 5o and 300. If the value is different, 
the tipp is 20%. 

Your tasks:

1. Calculate the tip, depending on the value. Create a variable called 'tip' for this. 
